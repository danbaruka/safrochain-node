module github.com/Safrochain_Org/safrochain/tests/interchaintest
...
replace (
	...
	// For this nested module, replace the parent reference with the current worktree.
