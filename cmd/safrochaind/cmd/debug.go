...
// get cmd to convert any bech32 address to a safrochain prefix.
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "bech32-convert [bech32 string]",
		Short: "Convert any bech32 string to the safrochain prefix",
		Long: `Convert any bech32 string to the safrochain prefix
Especially useful for converting cosmos addresses to safrochain addresses
Example:
	safrochaind bech32-convert safrochain1ey69r37gfxvxg62sh4r0ktpuc46pzjrm5cxnjg -p osmo
	`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
